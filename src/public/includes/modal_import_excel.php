    ...
    <div class="modal-content">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; margin-bottom: 20px; font-size: 13px; color: #0369a1;">
                ...
                File yang diupload harus berformat <b>.csv</b>.<br>
                Jika dari Excel, pilih <b>Save As > CSV (Comma delimited)</b>.
            </div>

            <div class="form-group">
                <label>Pilih File CSV</label>
                <input type="file" name="file_excel" class="form-input" accept=".csv" required>
            </div>
