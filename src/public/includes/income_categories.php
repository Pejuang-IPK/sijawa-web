    ...
    <div class="section-header">
        ...
        <div class="section-actions">
            <div class="date-filter-group">
                <select class="filter-select" id="periodTypeIncome" onchange="updateOpsiNilai()">
                ...
                <select class="filter-select" id="valueSelectIncome" onchange="terapkanFilter()" style="<?php echo $period == 'semua' ? 'display:none;' : ''; ?>">
                    <option value="">Memuat...</option>
                </select>
            </div>
            <button class="btn-add-category" onclick="bukaModalKategori('Pemasukan')">
